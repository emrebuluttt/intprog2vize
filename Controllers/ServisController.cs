...
namespace haber02.Controllers
{
    public class ServisController : ApiController
    {
        ...
        {
            List<HaberModel> liste = db.Haber.OrderByDescending(o => o.HaberId).Take(
           s).Select(x => new HaberModel()
           {
               HaberId = x.HaberId,
               Baslik = x.Baslik,
               Icerik = x.Icerik,
        ...
        {
            List<HaberModel> liste = db.Haber.Where(s => s.KategoriId == katId).Select
           (x => new HaberModel()
           {
               HaberId = x.HaberId,
               Baslik = x.Baslik,
        ...
        {
            List<HaberModel> liste = db.Haber.Where(s => s.UyeId == uyeId).Select(x =>
           new HaberModel()
           {
               HaberId = x.HaberId,
               Baslik = x.Baslik,
        ...
        {
            HaberModel kayit = db.Haber.Where(s => s.HaberId == haberId).Select(x =>
           new HaberModel()
           {
               HaberId = x.HaberId,
               Baslik = x.Baslik,
            ...
            UyeModel kayit = db.Uye.Where(s => s.UyeId == uyeId).Select(x => new UyeModel()
 {
        ...
        {
            List<YorumModel> liste = db.Yorum.Where(s => s.HaberId == haberId).Select(
           x => new YorumModel()
           {
               YorumId = x.YorumId,
               YorumIcerik = x.YorumIcerik,
        ...
        {
            List<YorumModel> liste = db.Yorum.OrderByDescending(o => o.HaberId).Take(s)
